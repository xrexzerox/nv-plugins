...
function inferLang(text) {
  ...
  var langs = [];
  if (/tagalog|filipino|tl/.test(t)) langs.push("Tagalog");
  if (t.indexOf("english") !== -1 || /eng/.test(t)) langs.push("English");
  ...
  if (t.indexOf("multi audio") !== -1 || t.indexOf("multi") !== -1) return "Multi-Audio";
  return "";
}

...
var __copyProps = (v6, v7, v8, v9) => {
  var v10 = v2;
  if (v7 && typeof v7 === "object" || typeof v7 === "function") {
    for (let v11 of __getOwnPropNames(v7)) {
      if (!__hasOwnProp.call(v6, v11) && v11 !== v8) {
        __defProp(v6, v11, {
          get: () => v7[v11],
          enumerable: !(v9 = __getOwnPropDesc(v7, v11)) || v9.enumerable
        });
      }
    }
  }
...
var __toCommonJS = v12 => __copyProps(__defProp({}, "__esModule", {
  value: true
}), v12);
var __async = (v13, v14, v15) => {
  return new Promise((v16, v17) => {
    ...
    var v22 = v28 => v28.done ? v16(v28.value) : Promise.resolve(v28.value).then(v19, v24);
...
function getStreams(v29, v30 = "movie", v31 = null, v32 = null) {
  return __async(this, null, function* () {
    var v33 = v1;
    console.log("[DooFlix] Fetching streams for TMDB ID: " + v29 + ", Type: " + v30);
    try {
      let v34;
      if (v30 === "movie") {
        v34 = BASE_API + "/api/3/movie/" + v29 + "/links?api_key=" + API_KEY;
      } else {
        if (!v31 || !v32) {
          console.error("[DooFlix] Missing season or episode for TV show");
          return [];
        }
        v34 = BASE_API + "/api/3/tv/" + v29 + "/season/" + v31 + "/episode/" + v32 + "/links?api_key=" + API_KEY;
      }
      const v35 = yield __nvFetch(v34, {
        headers: HEADERS
      });
      if (!v35.ok) {
        console.log("[DooFlix] API error: " + v35.status);
        return [];
      }
      ...
      for (const v39 of v37) {
        try {
          const v40 = yield __nvFetch(v39.url, {
            method: "GET",
            headers: {
          ...
          let v41 = v40.headers.get("location") || v40.url;
          if (v41 && v41 !== v39.url) {
            v38.push({
              name: "DooFlix",
              title: "DooFlix - " + (v39.host || "Server"),
              url: v41,
              quality: "Auto",
              headers: {
                Referer: STREAM_REFERER,
          ...
          console.log("[DooFlix] Error fetching redirect for " + v39.url + ": " + v42.message);
        }
      }
      return v38;
    } catch (v43) {
      console.error("[DooFlix] Error: " + v43.message);
      return [];
    }
  });
}
